...
const PARSERS = { picpay: parsePicPayFile, pagbank: parsePagBankFile };
const MIME_TYPES = {
  picpay: ['*/*'],
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.hint}>
          {account.bankType === 'picpay'
            ? 'Selecione o extrato exportado do PicPay (.xlsx ou .csv)'
            : 'Selecione o extrato exportado do PagBank (.xlsx)'}
        </Text>
